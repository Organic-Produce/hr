...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Extra_document.type'
        db.add_column(u'register_extra_document', 'type',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Extra_document.type'
        db.delete_column(u'register_extra_document', 'type')
    ...
    models = {
        ...
        u'register.extra_document': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True'})
        },
