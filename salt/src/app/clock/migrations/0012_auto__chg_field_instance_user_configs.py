...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Instance.user_configs'
        db.alter_column('clock_instances', 'user_configs', self.gf(u'select_multiple_field.models.SelectMultipleField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Instance.user_configs'
        db.alter_column('clock_instances', 'user_configs', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        u'clock.instance': {
            ...
            'user_configs': (u'select_multiple_field.models.SelectMultipleField', [], {'default': '0', 'max_length': '50'}),
