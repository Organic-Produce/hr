...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Instance.employee_group'
        db.delete_column('clock_instances', 'employee_group_id')

        # Adding field 'Instance.ganlytics_code'
        db.add_column('clock_instances', 'ganlytics_code',
                      self.gf('django.db.models.fields.CharField')(default='UA-53621908-1', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Instance.employee_group'
        db.add_column('clock_instances', 'employee_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.Group']),
                      keep_default=False)

        # Deleting field 'Instance.ganlytics_code'
        db.delete_column('clock_instances', 'ganlytics_code')
