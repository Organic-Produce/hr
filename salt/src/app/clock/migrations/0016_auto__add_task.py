...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'clock', ['Task'])


    def backwards(self, orm):
        # Deleting model 'Task'
        db.delete_table(u'clock_task')
    ...
    models = {
        ...
        u'clock.site': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PolygonField', [], {'default': '<Polygon object at 0x9e19e60>'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
