...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ScheduleEntry.weekday'
        db.delete_column(u'clock_scheduleentry', 'weekday')

        # Adding field 'ScheduleEntry.weekdays'
        db.add_column(u'clock_scheduleentry', 'weekdays',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


        # Changing field 'ScheduleEntry.start'
        db.alter_column(u'clock_scheduleentry', 'start', self.gf('django.db.models.fields.TimeField')())

        # Changing field 'ScheduleEntry.end'
        db.alter_column(u'clock_scheduleentry', 'end', self.gf('django.db.models.fields.TimeField')())

    def backwards(self, orm):
        # Adding field 'ScheduleEntry.weekday'
        db.add_column(u'clock_scheduleentry', 'weekday',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'ScheduleEntry.weekdays'
        db.delete_column(u'clock_scheduleentry', 'weekdays')


        # Changing field 'ScheduleEntry.start'
        db.alter_column(u'clock_scheduleentry', 'start', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ScheduleEntry.end'
        db.alter_column(u'clock_scheduleentry', 'end', self.gf('django.db.models.fields.DateTimeField')())
