...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('clock_instances', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('admin', self.gf('django.db.models.fields.related.ForeignKey')(related_name='instance', to=orm['profiles.Profile'])),
            ('employee_group', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.Group'])),
            ('week_ending_day', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=2)),
            ('week_ending_hour', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=2)),
            ('multi_manager', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('multi_site', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('iframes', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('url', self.gf('django.db.models.fields.URLField')(default='https://preprod.hrpower.com/', max_length=200)),
        ))
        db.send_create_signal(u'clock', ['Instance'])


    def backwards(self, orm):
        # Deleting model 'Instance'
        db.delete_table('clock_instances')
