...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instance.memos'
        db.add_column('clock_instances', 'memos',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Instance.report'
        db.add_column('clock_instances', 'report',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)

        # Adding field 'Instance.personal_report'
        db.add_column('clock_instances', 'personal_report',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Instance.daily_notes'
        db.add_column('clock_instances', 'daily_notes',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Instance.user_configs'
        db.add_column('clock_instances', 'user_configs',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instance.memos'
        db.delete_column('clock_instances', 'memos')

        # Deleting field 'Instance.report'
        db.delete_column('clock_instances', 'report')

        # Deleting field 'Instance.personal_report'
        db.delete_column('clock_instances', 'personal_report')

        # Deleting field 'Instance.daily_notes'
        db.delete_column('clock_instances', 'daily_notes')

        # Deleting field 'Instance.user_configs'
        db.delete_column('clock_instances', 'user_configs')
    ...
    models = {
        ...
        u'clock.instance': {
            ...
            'user_configs': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
