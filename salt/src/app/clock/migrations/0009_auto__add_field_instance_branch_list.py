...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instance.branch_list'
        db.add_column('clock_instances', 'branch_list',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instance.branch_list'
        db.delete_column('clock_instances', 'branch_list')
