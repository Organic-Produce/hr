...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instance.manager_messages'
        db.add_column('clock_instances', 'manager_messages',
        ...
        # Adding field 'Instance.force_hours'
        db.add_column('clock_instances', 'force_hours',
                      self.gf('django.db.models.fields.IntegerField')(default=9, max_length=2),
                      keep_default=False)

        # Adding field 'Instance.strict_restriction'
        db.add_column('clock_instances', 'strict_restriction',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instance.manager_messages'
        db.delete_column('clock_instances', 'manager_messages')

        # Deleting field 'Instance.force_clocout'
        db.delete_column('clock_instances', 'force_clocout')

        # Deleting field 'Instance.force_hours'
        db.delete_column('clock_instances', 'force_hours')

        # Deleting field 'Instance.strict_restriction'
        db.delete_column('clock_instances', 'strict_restriction')
    ...
    models = {
        ...
        u'clock.instance': {
            ...
            'force_clocout': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
