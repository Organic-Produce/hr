...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'clock_schedule', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clock.Site'])),
            ('worker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Profile'])),
        ))
        db.send_create_signal(u'clock', ['Schedule'])

        # Adding model 'ScheduleEntry'
        db.create_table(u'clock_scheduleentry', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start', self.gf('django.db.models.fields.DateTimeField')()),
            ('end', self.gf('django.db.models.fields.DateTimeField')()),
            ('schedule', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entries', to=orm['clock.Schedule'])),
        ))
        db.send_create_signal(u'clock', ['ScheduleEntry'])


    def backwards(self, orm):
        # Deleting model 'Schedule'
        db.delete_table(u'clock_schedule')

        # Deleting model 'ScheduleEntry'
        db.delete_table(u'clock_scheduleentry')
