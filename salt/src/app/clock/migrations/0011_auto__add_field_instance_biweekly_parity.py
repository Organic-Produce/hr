...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instance.biweekly_parity'
        db.add_column('clock_instances', 'biweekly_parity',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instance.biweekly_parity'
        db.delete_column('clock_instances', 'biweekly_parity')
