...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.geo_frecuency'
        db.add_column('clock_profiles', 'geo_frecuency',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=16),
                      keep_default=False)

        # Adding field 'Profile.geo_radius'
        db.add_column('clock_profiles', 'geo_radius',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.geo_frecuency'
        db.delete_column('clock_profiles', 'geo_frecuency')

        # Deleting field 'Profile.geo_radius'
        db.delete_column('clock_profiles', 'geo_radius')
