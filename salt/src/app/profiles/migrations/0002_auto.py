...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field employees on 'Profile'
        m2m_table_name = db.shorten_name('clock_profiles_employees')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_profile', models.ForeignKey(orm[u'profiles.profile'], null=False)),
            ('to_profile', models.ForeignKey(orm[u'profiles.profile'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_profile_id', 'to_profile_id'])


    def backwards(self, orm):
        # Removing M2M table for field employees on 'Profile'
        db.delete_table(db.shorten_name('clock_profiles_employees'))
