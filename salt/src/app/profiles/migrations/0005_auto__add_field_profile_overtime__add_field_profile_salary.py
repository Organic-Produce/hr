...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.overtime'
        db.add_column('clock_profiles', 'overtime',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=16),
                      keep_default=False)

        # Adding field 'Profile.salary'
        db.add_column('clock_profiles', 'salary',
                      self.gf('django.db.models.fields.DecimalField')(default=7.25, max_digits=16, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.overtime'
        db.delete_column('clock_profiles', 'overtime')

        # Deleting field 'Profile.salary'
        db.delete_column('clock_profiles', 'salary')
