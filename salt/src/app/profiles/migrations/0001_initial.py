...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('clock_profiles', (
            ...
            ('employment_type', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=16)),
            ('pay_type', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=16)),
        ))
        db.send_create_signal(u'profiles', ['Profile'])

        # Adding M2M table for field groups on 'Profile'
        m2m_table_name = db.shorten_name('clock_profiles_groups')
        ...
        m2m_table_name = db.shorten_name('clock_profiles_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profile', models.ForeignKey(orm[u'profiles.profile'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('clock_profiles')

        # Removing M2M table for field groups on 'Profile'
        db.delete_table(db.shorten_name('clock_profiles_groups'))

        # Removing M2M table for field user_permissions on 'Profile'
        db.delete_table(db.shorten_name('clock_profiles_user_permissions'))
