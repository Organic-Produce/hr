...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Applicant.shift'
        db.alter_column(u'profiles_applicant', 'shift', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=20))

        # Changing field 'Applicant.availability'
        db.alter_column(u'profiles_applicant', 'availability', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Applicant.shift'
        db.alter_column(u'profiles_applicant', 'shift', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'Applicant.availability'
        db.alter_column(u'profiles_applicant', 'availability', self.gf('django.db.models.fields.CharField')(max_length=2))
    ...
    models = {
        ...
        u'profiles.applicant': {
            ...
            'availability': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'default': "''", 'max_length': '20'}),
            ...
            'shift': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'default': "''", 'max_length': '20'}),
