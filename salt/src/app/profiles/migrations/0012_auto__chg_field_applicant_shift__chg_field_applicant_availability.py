...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'profiles_applicant', 'shift', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Applicant.availability'
        db.alter_column(u'profiles_applicant', 'availability', self.gf('django.db.models.fields.CharField')(max_length=20))
