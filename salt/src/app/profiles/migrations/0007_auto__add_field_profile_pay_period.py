...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.pay_period'
        db.add_column('clock_profiles', 'pay_period',
                      self.gf('django.db.models.fields.IntegerField')(default=2, max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.pay_period'
        db.delete_column('clock_profiles', 'pay_period')
