...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applicant.weekdays'
        db.add_column(u'profiles_applicant', 'weekdays',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Applicant.weekends'
        db.add_column(u'profiles_applicant', 'weekends',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Applicant.first'
        db.add_column(u'profiles_applicant', 'first',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Applicant.second'
        db.add_column(u'profiles_applicant', 'second',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Applicant.third'
        db.add_column(u'profiles_applicant', 'third',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Applicant.weekdays'
        db.delete_column(u'profiles_applicant', 'weekdays')

        # Deleting field 'Applicant.weekends'
        db.delete_column(u'profiles_applicant', 'weekends')

        # Deleting field 'Applicant.first'
        db.delete_column(u'profiles_applicant', 'first')

        # Deleting field 'Applicant.second'
        db.delete_column(u'profiles_applicant', 'second')

        # Deleting field 'Applicant.third'
        db.delete_column(u'profiles_applicant', 'third')
    ...
    models = {
        ...
        u'profiles.applicant': {
            ...
            'availability': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20'}),
            ...
            'shift': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20'}),
